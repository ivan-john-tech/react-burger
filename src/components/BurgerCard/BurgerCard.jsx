    ...
    return (
        ...
        <div className={cardStyles.card} onClick={onClick}>
            ...
            <div className={cardStyles.price}>
                ...
                <path d="M12.6465 21.3008C12.5592 21.3844 12.6674 21.5223 12.7693 21.4574L21.7887 15.7178C21.9203 15.634 22 15.4889 22 15.3329C22 15.0122 21.6778 14.7916 21.3788 14.9076L18.1046 16.1777C17.9818 16.2254 17.8696 16.2968 17.7745 16.3879L12.6465 21.3008Z" fill="#F2F2F3" />
